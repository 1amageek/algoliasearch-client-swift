...
public extension Index {
     ...
     */
    @discardableResult
    func getRule(withID objectID: ObjectID,
                 requestOptions: RequestOptions? = nil,
     ...
     */
    @discardableResult
    func deleteRule(withID objectID: ObjectID,
                    forwardToReplicas: Bool? = nil,
                    requestOptions: RequestOptions? = nil,
                    completion: @escaping ResultTaskCallback<IndexRevision>) -> Operation {
     ...
     */
    @discardableResult
    func searchRules(_ query: RuleQuery,
                     requestOptions: RequestOptions? = nil,
     ...
     */
    @discardableResult
    func clearRules(forwardToReplicas: Bool? = nil,
                    requestOptions: RequestOptions? = nil,
                    completion: @escaping ResultTaskCallback<IndexRevision>) -> Operation {
     ...
     */
    @discardableResult
    func replaceAllRules(with rules: [Rule],
                         forwardToReplicas: Bool? = nil,
                         requestOptions: RequestOptions? = nil,
                         completion: @escaping ResultTaskCallback<IndexRevision>) -> Operation {
