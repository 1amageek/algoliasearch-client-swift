...
extension ABTestResponse: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.abTestID = try container.decode(ABTestID.self, forKey: .abTestID)
        self.clickSignificance = try container.decodeIfPresent(Double.self, forKey: .clickSignificance)
        self.conversionSignificance = try container.decodeIfPresent(Double.self, forKey: .conversionSignificance)
        self.createdAt = try container.decode(Date.self, forKey: .createdAt)
        self.endAt = try container.decode(Date.self, forKey: .endAt)
        self.name = try container.decode(String.self, forKey: .name)
        self.status = try container.decode(ABTestStatus.self, forKey: .status)
        let variants: [Variant] = try container.decode([ABTestResponse.Variant].self, forKey: .variants)
