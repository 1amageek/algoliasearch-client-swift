...
extension Place: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        localeNames = try container.decodeIfPresent([String].self, forKey: .localeNames)
        administrative = try container.decodeIfPresent([String].self, forKey: .administrative)
        countryCode = try container.decodeIfPresent(Country.self, forKey: .countryCode)
        postcode = try container.decodeIfPresent([String].self, forKey: .postcode)
        population = try container.decodeIfPresent(Double.self, forKey: .population)
        importance = try container.decodeIfPresent(Int.self, forKey: .importance)
        tags = try container.decodeIfPresent([String].self, forKey: .tags)
        adminLevel = try container.decodeIfPresent(Int.self, forKey: .adminLevel)
        ...
        isCountry = try container.decodeIfPresent(Bool.self, forKey: .isCountry)
        isCity = try container.decodeIfPresent(Bool.self, forKey: .isCity)
        isSuburb = try container.decodeIfPresent(Bool.self, forKey: .isSuburb)
        isHighway = try container.decodeIfPresent(Bool.self, forKey: .isHighway)
