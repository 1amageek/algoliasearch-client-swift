...
public extension Index {
     ...
     */
    @discardableResult
    func searchForFacetValues(of facetName: Attribute,
     ...
     */
    @discardableResult
    func findObject<T: Decodable>(matching predicate: @escaping (T) -> Bool,
     ...
     */
    @discardableResult
    func findObject<T: Decodable>(matching predicate: (T) -> Bool,
                                  for query: Query = .init(),
                                  paginate: Bool = true,
