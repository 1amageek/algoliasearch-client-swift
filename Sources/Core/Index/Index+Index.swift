...
public extension Index {
     ...
     */
    @discardableResult
    func delete(requestOptions: RequestOptions? = nil) throws -> WaitableWrapper<IndexDeletion> {
        let command = Command.Index.DeleteIndex(indexName: name, requestOptions: requestOptions)
     ...
     */
    @discardableResult
    func exists(completion: @escaping ResultCallback<Bool>) -> Operation & TransportTask {
     ...
     */
    @discardableResult
    func move(to destination: IndexName,
                                 requestOptions: RequestOptions? = nil,
                                 completion: @escaping ResultTaskCallback<IndexRevision>) -> Operation & TransportTask {
