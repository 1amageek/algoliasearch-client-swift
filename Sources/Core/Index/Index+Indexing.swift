...
public extension Index {
     ...
     */
    @discardableResult
    func saveObjects<T: Encodable>(_ objects: [T],
                                   autoGeneratingObjectID: Bool = false,
                                   requestOptions: RequestOptions? = nil,
     ...
     */
    @discardableResult
    func getObject<T: Decodable>(withID objectID: ObjectID,
     ...
     */
    @discardableResult
    func replaceObject<T: Encodable>(withID objectID: ObjectID,
                                     by object: T,
                                     requestOptions: RequestOptions? = nil,
     ...
     */
    @discardableResult
    func replaceObjects<T: Encodable>(replacements: [(objectID: ObjectID, object: T)],
                                      requestOptions: RequestOptions? = nil,
                                      completion: @escaping ResultBatchesCallback) -> Operation {
     ...
     */
    @discardableResult
    func deleteObject(withID objectID: ObjectID,
                      requestOptions: RequestOptions? = nil,
     ...
     */
    @discardableResult
    func deleteObjects(withIDs objectIDs: [ObjectID],
                       requestOptions: RequestOptions? = nil,
                       completion: @escaping ResultBatchesCallback) -> Operation {
     ...
     */
    @discardableResult
    func deleteObjects(byQuery query: DeleteByQuery,
                       requestOptions: RequestOptions? = nil,
     ...
     */
    @discardableResult
    func partialUpdateObject(withID objectID: ObjectID,
     ...
     */
    @discardableResult
    func partialUpdateObjects(updates: [(objectID: ObjectID, update: PartialUpdate)],
                              createIfNotExists: Bool = true,
                              requestOptions: RequestOptions? = nil,
                              completion: @escaping ResultBatchesCallback) -> Operation {
     ...
     */
    @discardableResult
    func batch(_ batchOperations: [BatchOperation],
               requestOptions: RequestOptions? = nil) throws -> WaitableWrapper<BatchesResponse> {
     ...
     */
    @discardableResult
    func clearObjects(requestOptions: RequestOptions? = nil,
                      completion: @escaping ResultTaskCallback<IndexRevision>) -> Operation & TransportTask {
     ...
     */
    @discardableResult
    func clearObjects(requestOptions: RequestOptions? = nil) throws -> WaitableWrapper<IndexRevision> {
        let command = Command.Indexing.ClearObjects(indexName: name, requestOptions: requestOptions)
        return try execute(command)
    }
        ...
        copy([.settings, .rules, .synonyms], to: destinationIndexName) { extract($0) { copyTaskWrapper in
            destinationIndex.batch(moveOperations) { extract($0) { batchTaskWrapper in
                destinationIndex.move(to: sourceIndexName) { extract($0) { moveTaskWrapper in
                    ...
                    WaitableWrapper(tasks, tasksToWait: tasksToWait).wait { result in
...
extension Index {
    ...
    @discardableResult
    func internalBatch(_ batchOperations: [BatchOperation],
                       requestOptions: RequestOptions? = nil,
