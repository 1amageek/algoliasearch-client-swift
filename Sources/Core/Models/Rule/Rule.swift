...
extension Rule: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.conditions = try container.decodeIfPresent([Rule.Condition].self, forKey: .conditions)
        self.consequence = try container.decodeIfPresent(Rule.Consequence.self, forKey: .consequence)
        self.isEnabled = try container.decodeIfPresent(Bool.self, forKey: .isEnabled)
        self.validity = try container.decodeIfPresent([TimeRange].self, forKey: .validity)
