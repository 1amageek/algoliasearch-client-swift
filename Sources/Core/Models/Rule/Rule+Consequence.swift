...
extension Rule.Consequence {
    ...
    struct Params: Builder, Codable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            queryTextAlteration = try container.decodeIfPresent(Rule.Consequence.QueryTextAlteration.self, forKey: .query)
            automaticFacetFilters = try container.decodeIfPresent([Rule.AutomaticFacetFilters].self, forKey: .automaticFacetFilters)
            automaticOptionalFacetFilters = try container.decodeIfPresent([Rule.AutomaticFacetFilters].self, forKey: .automaticOptionalFacetFilters)
...
extension Rule.Consequence: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.promote = try container.decodeIfPresent([Rule.Promotion].self, forKey: .promote)
        self.filterPromotes = try container.decodeIfPresent(Bool.self, forKey: .filterPromotes)
