...
extension Log: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        answerCode = try container.decode(String.self, forKey: .answerCode)
        queryBody = try container.decode(String.self, forKey: .queryBody)
        answer = try container.decode(String.self, forKey: .answer)
        url = try container.decode(String.self, forKey: .url)
        ip = try container.decode(String.self, forKey: .ip)
        queryHeaders = try container.decode(String.self, forKey: .queryHeaders)
        ...
        indexName = try container.decodeIfPresent(IndexName.self, forKey: .indexName)
        exhaustiveNbHits = try container.decodeIfPresent(Bool.self, forKey: .exhaustiveNbHits)
        exhaustiveFaceting = try container.decodeIfPresent(Bool.self, forKey: .exhaustiveFaceting)
        queryParams = try container.decodeIfPresent(String.self, forKey: .queryParams)
        innerQueries = try container.decodeIfPresent([Log.InnerQuery].self, forKey: .innerQueries)
    }
