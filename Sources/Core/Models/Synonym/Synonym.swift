...
extension Synonym: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        let objectID: ObjectID = try container.decode(ObjectID.self, forKey: .objectID)
        let type: SynonymType = try container.decode(SynonymType.self, forKey: .type)
        switch type {
            case .oneWay:
                let input: String = try container.decode(String.self, forKey: .input)
                let synonyms: [String] = try container.decode([String].self, forKey: .synonyms)
            ...
            case .altCorrection1, .altCorrection2:
                ...
                let word: String = try container.decode(String.self, forKey: .word)
                let corrections: [String] = try container.decode([String].self, forKey: .corrections)
            ...
            case .placeholder:
                ...
                let replacements: [String] = try container.decode([String].self, forKey: .replacements)
