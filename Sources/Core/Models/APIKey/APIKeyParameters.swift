...
extension APIKeyParameters: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.ACLs = try container.decode([ACL].self, forKey: .ACLs)
        self.validity = try container.decodeIfPresent(Double.self, forKey: .validity)
        self.maxHitsPerQuery = try container.decodeIfPresent(Int.self, forKey: .maxHitsPerQuery)
        self.maxQueriesPerIPPerHour = try container.decodeIfPresent(Int.self, forKey: .maxQueriesPerIPPerHour)
        self.indices = try container.decodeIfPresent([IndexName].self, forKey: .indices)
        self.referers = try container.decodeIfPresent([String].self, forKey: .referers)
