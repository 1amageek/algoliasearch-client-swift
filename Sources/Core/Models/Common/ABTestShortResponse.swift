...
extension ABTestShortResponse: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        let variants: [Variant] = try container.decode([ABTestShortResponse.Variant].self, forKey: .variants)
...
extension ABTestShortResponse {
    ...
    public struct Variant: Codable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.trafficPercentage = try container.decode(Int.self, forKey: .trafficPercentage)
