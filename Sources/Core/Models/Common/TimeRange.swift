...
extension TimeRange: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        let fromTimestamp: TimeInterval = try container.decode(Double.self, forKey: .from)
        let untilTimestamp: TimeInterval = try container.decode(Double.self, forKey: .until)
