...
public extension SearchClient {
     ...
     */
    @discardableResult
    func listIndices(requestOptions: RequestOptions? = nil,
     ...
     */
    @discardableResult
    func listIndices(requestOptions: RequestOptions? = nil) throws -> IndicesListResponse {
        let command = Command.MultipleIndex.ListIndices(requestOptions: requestOptions)
     ...
     */
    @discardableResult
    func listIndexAPIKeys(requestOptions: RequestOptions? = nil,
     ...
     */
    @discardableResult
    func listIndexAPIKeys(requestOptions: RequestOptions? = nil) throws -> ListAPIKeysResponse {
        let command = Command.MultipleIndex.ListIndexAPIKeys(requestOptions: requestOptions)
        return try execute(command)
    }
     ...
     */
    @discardableResult
    func multipleQueries(queries: [IndexedQuery],
     ...
     */
    @discardableResult
    func multipleGetObjects(requests: [ObjectRequest],
                            requestOptions: RequestOptions? = nil,
     ...
     */
    @discardableResult
    func multipleBatchObjects(operations: [(IndexName, BatchOperation)],
                              requestOptions: RequestOptions? = nil,
