...
class MultiClusterCommandTest: XCTestCase, AlgoliaCommandTest {
  ...
  func testAssignUserID() {
    let command = Command.MultiCluster.User.Assign(userID: test.userID, clusterName: test.clusterName, requestOptions: test.requestOptions)
    check(command: command,
          callType: .write,
          method: .post,
  ...
  func testGetUserID() {
    let command = Command.MultiCluster.User.Get(userID: test.userID, requestOptions: test.requestOptions)
    check(command: command,
          callType: .read,
          method: .get,
  ...
  func testGetUserIDList() {
    let command = Command.MultiCluster.User.GetList(page: 10, hitsPerPage: 100, requestOptions: test.requestOptions)
    check(command: command,
          callType: .read,
          method: .get,
          urlPath: "/1/clusters/mapping",
  ...
  func testRemoveUserID() {
    let command = Command.MultiCluster.User.Remove(userID: test.userID, requestOptions: test.requestOptions)
    check(command: command,
          callType: .write,
          method: .delete,
          urlPath: "/1/clusters/mapping",
  ...
  func testSearchUserID() {
    let command = Command.MultiCluster.User.Search(userIDQuery: "testQuery", requestOptions: test.requestOptions)
    check(command: command,
          callType: .read,
          method: .post,
  ...
  func testAssignUserIDs() {
    let command = Command.MultiCluster.User.BatchAssign(userIDs: ["u1", "u2"], clusterName: test.clusterName, requestOptions: test.requestOptions)
    check(command: command,
          callType: .write,
          method: .post,
  ...
  func testHasPendingMapping() {
    let command = Command.MultiCluster.HasPendingMapping(retrieveMapping: true, requestOptions: test.requestOptions)
    check(command: command,
          callType: .read,
          method: .get,
